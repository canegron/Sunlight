...
puerto = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2NhbmVncm9uL1N1bmxpZ2h0L21hc3Rlci9NZW51L21lbnUueG1s'.decode('base64')
...
addon = xbmcaddon.Addon('plugin.video.sunlight')
...
SOURCES = [{"url": puerto, "fanart": "https://raw.githubusercontent.com/canegron/Sunlight/master/Images/fanart.jpg"}]
	...
	try:
		if os.path.exists(favorites) == True:
			...
			if FAV == "[]":
				...
				addDir('[/COLOR][COLOR white]Sunlight[/COLOR]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
				addDir('','',100,'',FANART,'','','','')
